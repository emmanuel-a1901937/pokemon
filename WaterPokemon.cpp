...
{ // Constructs a Water Pokemon using randomly generated stats and an inputted name
  srand(time(0));
  name = names;
  type = "Water";
...
void WaterPokemon::useMove(Move *move, Pokemon *targetPokemon)
{ // public function, called by Game object
...
void WaterPokemon::useAttack(Move *move, Pokemon *targetPokemon)
{
  ...
  {                                                    // if attack does not hit (based on randomNumber)
...
void WaterPokemon::useDefend(Move *move)
{
  ...
  {                                                         // if there is a change in Attack stat
    ...
    {                                                                                                                                  // if newAttack would be less than 1
  ...
  {                                                            // if there is a change in Defence stat
    ...
    {                                                                                                                                      // if newDefence would be less than 1
  ...
  {                                                      // if there is a change in Speed stat
    ...
    {                                                                                                                              // if newSpeed would be less than 1
